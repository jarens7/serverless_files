...
4. Deploy
serverless Deploy
5. Testing, run the following command and feel free to change the URL to where the file is being grabbed from, and also change the data name to something relevant:
